...
def requestExcel(apiTestCaseFilePath, sheet, rowNum, buildTimes):
	...
	if isinstance(dc.passObject,dict) or isinstance(dc.passObject,list):
		dc.passObject = json.dumps(dc.passObject)
	if isinstance(dc.passObjectValue,dict) or isinstance(dc.passObjectValue,list):
